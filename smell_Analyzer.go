...
func analyseStruct(structs[] Struct, projectName string) *os.File {
...
func analyseMethods(methods[]Method,projectName string) *os.File{
	pos:= strings.Index(projectName,".")
	str:= projectName[0:pos]
	projectName=str
...
func writeCodeSmellSumarry(structs[] Struct,methods[]Method, projectName string) *os.File {
	GodStruct:=0
	//DataStruct:=0
	FeatureEnvy:=0
	BrainMethod:=0
...
func writeCodeSmellList(structs[] Struct,method[] Method,projectName string) *os.File{
	pos:= strings.Index(projectName,".")
	str:= projectName[0:pos]
	projectName=str
